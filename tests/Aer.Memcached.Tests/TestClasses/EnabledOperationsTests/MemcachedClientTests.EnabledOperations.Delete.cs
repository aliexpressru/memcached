...
[TestClass]
public class MemcachedClientTests_EnabledOperations_Delete : MemcachedClientTestsBase
{
    public MemcachedClientTests_EnabledOperations_Delete() : base(
        isSingleNodeCluster: true,
        enabledOperations: EnabledOperations.Delete)
    {
    }
