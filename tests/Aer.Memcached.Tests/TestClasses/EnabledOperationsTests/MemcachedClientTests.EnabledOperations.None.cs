...
[TestClass]
public class MemcachedClientTests_EnabledOperations_None : MemcachedClientTestsBase
{
    public MemcachedClientTests_EnabledOperations_None() : base(
        isSingleNodeCluster: true,
        enabledOperations: EnabledOperations.None)
    {
    }
