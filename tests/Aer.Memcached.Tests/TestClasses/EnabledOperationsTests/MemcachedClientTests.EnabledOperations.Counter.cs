...
[TestClass]
public class MemcachedClientTests_EnabledOperations_Counter : MemcachedClientTestsBase
{
    public MemcachedClientTests_EnabledOperations_Counter() : base(
        isSingleNodeCluster: true,
        enabledOperations: EnabledOperations.Counter)
    {
    }
